# This is a rework of Google Tensorflow Example: 'retrain.py'
...
'''
  =======================================================================
                     ...
                     Self-defined "create_image_lists" (2017-09-12)
...
def self_defined_create_image_lists(image_dir, validation_percentage):
  """Builds a list of training images from the file system.
...
def run_bottleneck_on_image(sess, image_data, image_data_tensor,
  ...
  """
  print("[RUN: run_bottleneck_on_image]")
...
def maybe_download_and_extract(data_url):
  ...
  """
  print("[RUN: maybe_download_and_extract]")
...
def create_bottleneck_file(bottleneck_path, image_lists, label_name, index,
  ...
  print("[RUN: create_bottleneck_file]")
...
def get_or_create_bottleneck(sess, image_lists, label_name, index, image_dir,
  ...
  """
  print("[RUN: get_or_create_bottlenec]")
  label_lists = image_lists[label_name]
  sub_dir = label_lists['dir']
...
def get_random_cached_bottlenecks(sess, image_lists, how_many, category,
  ...
  Returns:
    ...
    relevant filenames.
  """
  print("[RUN: get_random_cached_bottlenecks]")
...
def get_random_distorted_bottlenecks(
  ...
  """
  print("[RUN: get_random_distorted_bottlenecks]")
  class_count = len(image_lists.keys())
  bottlenecks = []
  ground_truths = []
  for unused_i in range(how_many):
...
def should_distort_images(flip_left_right, random_crop, random_scale,
  ...
  """
  print("[RUN: should_distort_images]")
...
def add_input_distortions(flip_left_right, random_crop, random_scale,
  ...
  """
  print("[RUN: add_input_distortions]")
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor,
  ...
  """
  print("[RUN: add_final_training_ops]")
...
def main(_):
  ...
  prepare_file_system()   # ---> Setup the directory we'll write summaries to for TensorBoard
  ...
  #BY PASS original "create_image_lists" function. Just self-defined function instead (2017-09-12)
  image_lists = self_defined_create_image_lists(FLAGS.image_dir,FLAGS.validation_percentage)
  class_count = len(image_lists.keys())
  if class_count == 0:
